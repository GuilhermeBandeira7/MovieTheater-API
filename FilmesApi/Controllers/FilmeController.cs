...
namespace FilmesAPI.Controllers
{
    ...
    public class FilmeController : ControllerBase
    {
        ...
        [HttpPost]
        [Authorize(Roles = "admin")] // only user admin have permission to add a movie
        ...
        [HttpGet]
        [Authorize(Roles = "admin, regular", Policy = "IdadeMinima")] // any user overage users can get a movie
