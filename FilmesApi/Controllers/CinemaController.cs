...
namespace FilmesAPI.Controllers
{
    ...
    public class CinemaController : ControllerBase
    {
        ...
        public IActionResult AdicionaCinema([FromBody] CreateCinemaDto cinemaDto)
        {
            ...
            return CreatedAtAction(nameof(RecuperaCinemasPorId), new { Id = readDto.Id }, readDto); //returning the result created in the action 
        }

        [HttpGet]
        public IActionResult RecuperaCinemas([FromQuery] string nomeDoFilme) //Get method using query parameters
        {
